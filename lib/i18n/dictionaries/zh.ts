...
export const zh: Dictionary = {
  ...
  booking: {
    ...
    error: "提交失败，请稍后重试。",
    prefer: "需要即时预订？请致电 {phone}、WhatsApp {whatsapp}、微信 {wechat}，或 LINE {line}。",
  },
  drivers: {
    eyebrow: "专业司机团队",
    title: "认识我们的司机",
  ...
  faqs: [
    {
      q: "如何预订专车？",
      a: "请致电 +44 7938 994070，WhatsApp +44 7938 994070，微信 kp61pke，或 LINE +44 7938 994070，或通过网站表单提交咨询。",
    },
    {
      q: "有哪些可用车辆？",
  ...
  contact: {
    pageTitle: "联系我们",
    pageSubtitle: "预订方式：致电、WhatsApp、微信、LINE，或在下方留言。",
    callUs: "全天候致电",
    office: "办公地址",
    formTitle: "发送留言",
    ...
    hoursValue: "全天候",
    hoursBody:
      "我们的专车司机全天候服务英国全境。可电话、WhatsApp、微信、LINE 或留言联系 — 每次出行我们都会选择最高效的路线。",
    social: "社交：",
    getTaxiOnline: "在线预订",
    yourName: "您的姓名 *",
    yourEmail: "您的邮箱 *",
  ...
  tours: {
    ...
    ctaBody: "立即致电、WhatsApp、微信或 LINE 联系，定制您的专属行程。",
    bookTour: "预订观光",
    items: [
      {
        id: "london",
